...
function SettingsTab:Init()
    ...
    self:AddSetting(generalSettingsGroup, Ext.Loca.GetTranslatedString("h3d507f295c0b468ea6429b9b00c3c4ed2534", "NPCs"), true, function(check)
        UI.NPCTab.Tab.Visible = check
    end)
    self:AddSetting(generalSettingsGroup, Ext.Loca.GetTranslatedString("hd3dd6bc5609a4d65a7f71567e596dc84b81d", "Whitelist"), false, function(check)
    ...
    self:AddSetting(sceneGroup, Ext.Loca.GetTranslatedString("ha5a309de2e9542b2999d70313cf9455ab451", "Show all animations regardless of scene type"), false, function(check)
...
function SettingsTab:AddSetting(group, label, defaultValue, callback)
